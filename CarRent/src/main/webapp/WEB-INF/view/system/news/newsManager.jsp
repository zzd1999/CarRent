...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'layedit'], function () {
        ...
        tableIns = table.render({
            ...
            , url: 'http://localhost:8080/CarRent_war_exploded/news/loadAllNews.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "http://localhost:8080/CarRent_war_exploded/news/loadAllNews.action?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.title + '】这个公告么？', function (index) {
                    //向服务端发送删除指令
                    $.post("http://localhost:8080/CarRent_war_exploded/news/deleteNews.action", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function openAddNews() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    //清空表单数据
                    $("#dataFrm")[0].reset();
                    url = "http://localhost:8080/CarRent_war_exploded/news/addNews.action";
                }
            });
        }
        ...
        function openUpdateNews(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "http://localhost:8080/CarRent_war_exploded/news/updateNews.action";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些公告么？', function (index) {
                //向服务端发送删除指令
                $.post("http://localhost:8080/CarRent_war_exploded/news/deleteBatchNews.action", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
