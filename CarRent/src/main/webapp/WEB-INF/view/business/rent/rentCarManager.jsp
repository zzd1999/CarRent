    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: 'http://localhost:8080/CarRent_war_exploded/car/loadAllCar.action?isrenting=0' //数据接口
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        $("#doSearch").click(function () {
            ...
            $.post("http://localhost:8080/CarRent_war_exploded/rent/checkCustomerExist.action", params, function (obj) {
        ...
        function openRentCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $.get("http://localhost:8080/CarRent_war_exploded/rent/initRentFrom.action",{
                        identity:identity,
                        price:price,
                        carnumber:carnumber
                    },function (obj) {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("http://localhost:8080/CarRent_war_exploded/rent/saveRent.action", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层
