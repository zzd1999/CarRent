...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("http://localhost:8080/CarRent_war_exploded/check/checkRentExist.action", {rentid: rentid}, function (obj) {
        ...
        function initCheckFormData(rentid) {
            $.post("http://localhost:8080/CarRent_war_exploded/check/initCheckFormData.action",{rentid:rentid},function (obj) {
                //检查单
                var check=obj.check;
                ...
                $("#car_carimg").attr("src","http://localhost:8080/CarRent_war_exploded/file/downloadShowFile.action?path="+car.carimg);
            })
        }
        //保存
        form.on("submit(doSubmit)",function () {
            var params = $("#checkFrm").serialize();
            $.post("http://localhost:8080/CarRent_war_exploded/check/saveCheck.action",params,function (obj) {
                layer.msg(obj.msg);
                $("#content").hide();
            })
            return false;
